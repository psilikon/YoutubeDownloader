...
$(document).ready(function() {
	$("#loading-background").css({ opacity: .7 });
	$("#go").click(function() {
...
<div class="vid-container">
  ...
  <div class="inner-container">
    ...
    <div class="box" id="formdiv">
      <h2>Youtube Audio Downloader</h2>
      <input type="text" placeholder="Paste video URL here..." id="url" name="url"/>
...
<!--      <p>Not a member? <span>Sign Up</span></p> -->
	...
	<div id="loading-background">
    	<div id="loading" class="ui-corner-all" >
      		...
      		<h1 style="color:gray;font-weight:bold;">Processing Audio please wait....</h1>
     	</div>
	</div>
</body>
</html>
